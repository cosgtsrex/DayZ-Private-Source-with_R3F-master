...
private ["_riflemenlist","_side","_leader_group","_initstring","_patrol_area_name","_rndpos","_groupheli","_heli","_leaderheli","_man2heli","_man3heli","_argc","_tracewhat","_grouptype","_respawn","_leader_weapon_names","_leader_items","_leader_tools","_soldier_weapon_names","_soldier_items","_soldier_tools"];
...
if(_respawn) then 
{
    null=[_leaderheli,_patrol_area_name,'nofollow','nowait','aware','showmarker','respawn',"delete:",SAR_DELETE_TIMEOUT] execVM 'addons\UPSMON\scripts\upsmon.sqf';
} else {
    null=[_leaderheli,_patrol_area_name,'nofollow','nowait','aware','showmarker',"delete:",SAR_DELETE_TIMEOUT] execVM 'addons\UPSMON\scripts\upsmon.sqf';
};
